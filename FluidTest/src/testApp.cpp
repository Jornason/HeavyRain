...
//    gui.show();
    ...
    gui.setup("panel");
    gui.add(fluidCellsX.set("fluidCellsX",100,20,400));
    gui.add(resizeFluid.set("resizeFluid",true));
    gui.add(colorMult.set("colorMult",20,0,100));
    gui.add(velocityMult.set("velocityMult",20,0,100));
    gui.add(viscocity.set("viscocity",0.005,0.0,  0.01));
    gui.add(colorDiffusion.set("colorDiffusion", 0.00015,0.0, 0.0003));
    gui.add(fadeSpeed.set("fadeSpeed",0.05,0.0,  0.1));
    gui.add(solverIterations.set("solverIterations",20, 1,  50));
    gui.add(deltaT.set("deltaT",2,0.1, 5));
    
    gui.add(doRGB.set("doRGB",true));
    gui.add(doVorticityConfinement.set("doVorticityConfinement",true));
    gui.add(drawFluid.set("drawFluid",true));
    gui.add(drawParticles.set("drawParticles",true));
    gui.add(wrap_x.set("wrap_x",true));
gui.add(wrap_y.set("wrap_y",true));
    gui.add(tuioXScaler.set("tuioXScaler",true));
    gui.add(tuioYScaler.set("tuioXScaler",true));
...
void testApp::mouseMoved(int x, int y){
    ...
    addToFluid(mouseNorm+1, mouseVel-1, true, true);
	pMouse = eventPos;
}
